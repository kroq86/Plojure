...
docker run --rm --platform linux/amd64 \
  ...
  "$IMAGE" \
  bash -lc 'set -e; fasm switch.asm switch.o; gcc -fPIC -c wrapper.c -o wrapper.o; gcc -shared -Wl,-z,noexecstack -o libcoroutines.so switch.o wrapper.o -lc'

echo "Built /Users/ll/Documents/Plojure/fasm/advanced/coroutines/libcoroutines.so"
